...
out.print(AddData.name);System.out.println(data); %></span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Update Student Details</h1>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <form action="updateData" method="Post">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="0" name="studentName" aria-describedby="emailHelp" placeholder="Student Name" >
                              
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword1">Student ID</label>
                                <input type="text" class="form-control" id="1" name="studentId" placeholder="Student Id">
                              </div>
                              <div class="form-group">
                                <label for="exampleFormControlSelect1">Year</label>
                                <select class="form-control" id="2" name="year">
                                  <option>F.E</option>
                                  <option>S.E</option>
                                  <option>T.E</option>
                                  <option>B.E</option>
                              ...
                              <div class="form-group">
                                ...
                                <select class="form-control" id="3" name="division">
                                  <option>A</option>
                                  <option>B</option>
                                  <option>C</option>                                  
                                </select>
                              ...
                              <div class="form-group">
                                <label for="exampleInput4">Subject 1</label>
                                <input type="number" class="form-control" name="sub1" id="4" placeholder="0/100">
                              </div>
                              <div class="form-group">
                                <label for="exampleInput5">Subject 2</label>
                                <input type="number" class="form-control" name="sub2" id="5" placeholder="0/100">
                              </div>
                              <div class="form-group">
                                <label for="exampleInput6">Subject 3</label>
                                <input type="number" class="form-control" name="sub3" id="6" placeholder="0/100">
                              </div>
                              <div class="form-group">
                                <label for="exampleInput7">Subject 4</label>
                                <input type="number" class="form-control" name="sub4" id="7" placeholder="0/100">
                              </div>
                              <div class="form-group">
                                <label for="exampleInput8">Subject 5</label>
                                <input type="number" class="form-control" name="sub5" id="8" placeholder="0/100">
                              </div>
