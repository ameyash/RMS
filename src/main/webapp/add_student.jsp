                    ...
                    <div class="card">
                        ...
                        <form action="addStudentData" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Name" name="studentName">
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <select class="form-control" id="exampleFormControlSelect2" name="division">
                                  <option>A</option>
                                  <option>B</option>
                                  <option>C</option>                                  
                                </select>
                              ...
                              <div class="form-group">
                                ...
                                <input type="number" min="0" max="100" class="form-control" id="exampleInput4" placeholder="0/100" name="sub1">
                              </div>
                              <div class="form-group">
                                <label for="exampleInput5">Subject 2</label>
                                <input type="number" min="0" max="100" class="form-control" id="exampleInput5" placeholder="0/100" name="sub2">
                              </div>
                              <div class="form-group">
                                <label for="exampleInput6">Subject 3</label>
                                <input type="number" min="0" max="100" class="form-control" id="exampleInput6" placeholder="0/100" name="sub3">
                              </div>
                              <div class="form-group">
                                <label for="exampleInput7">Subject 4</label>
                                <input type="number" min="0" max="100" class="form-control" id="exampleInput7" placeholder="0/100" name="sub4">
                              </div>
                              <div class="form-group">
                                <label for="exampleInput8">Subject 5</label>
                                <input type="number" min="0" max="100" class="form-control" id="exampleInput8" placeholder="0/100" name="sub5">
                              </div>
