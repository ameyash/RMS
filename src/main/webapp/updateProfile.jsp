...
<head>
  ...
  window.onload = function () {
	  document.getElementById("email").value = "<%=AddData.email%>";
	  document.getElementById("name").value = "<%=AddData.name%>";
	  document.getElementById("password").value = "<%=AddData.password%>";
	  document.getElementById("Rpassword").value = "<%=AddData.password%>";
  }
  </script>	
</head>
